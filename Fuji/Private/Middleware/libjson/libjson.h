...
*/
	   ...
	   extern "C" {
		  ...
		  */
		  ...
		  JSONNODE * json_new_b(json_const json_char * name, int value);  //because C bools are ints and C++ will implicitly cast it
		  ...
		  int json_empty(json_const JSONNODE * node);
		  ...
		  int json_as_bool(json_const JSONNODE * node);
