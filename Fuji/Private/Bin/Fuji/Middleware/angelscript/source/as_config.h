...
// GNU C
	...
	// Support native calling conventions on x86, MIPS, and SH4, but not 64bit
		...
		#define ASM_AT_N_T
			...
			#define AS_X86
		#endif
		#if defined(_MIPS_ARCH) || defined(_mips) || defined(__mips__) || defined(__MIPSEL__) || defined(__PSP__) || defined(__psp__) || defined(_EE_) || defined(_PSP)
			#define AS_MIPS
		#endif
		#ifdef __SH4_SINGLE_ONLY__
			#define AS_SH4
		#endif
		#if defined(__PPC__) || defined(__PPU__)
			#define AS_PPC
		#endif
	#endif
