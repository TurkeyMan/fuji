...
static uint32 gMFTexturePlatformAvailability[TexFmt_Max] =
{
	...
	MFBIT(MFDD_D3D9)|MFBIT(MFDD_D3D11)|MFBIT(MFDD_XBox)|MFBIT(MFDD_OpenGL),		// TexFmt_A1R5G5B5
	...
	MFBIT(MFDD_D3D9)|MFBIT(MFDD_D3D11)|MFBIT(MFDD_OpenGL),						// TexFmt_ABGR_F16
	MFBIT(MFDD_D3D9)|MFBIT(MFDD_D3D11)|MFBIT(MFDD_OpenGL),						// TexFmt_ABGR_F32

	MFBIT(MFDD_XBox)|MFBIT(MFDD_OpenGL)|MFBIT(MFDD_PSP)|MFBIT(MFDD_PS2),		// TexFmt_I8
	MFBIT(MFDD_PSP)|MFBIT(MFDD_PS2),											// TexFmt_I4

	MFBIT(MFDD_D3D9)|MFBIT(MFDD_D3D11)|MFBIT(MFDD_XBox)|MFBIT(MFDD_OpenGL),		// TexFmt_DXT1 // 1 bit alpha
	MFBIT(MFDD_D3D9)|MFBIT(MFDD_XBox),											// TexFmt_DXT2
	MFBIT(MFDD_D3D9)|MFBIT(MFDD_D3D11)|MFBIT(MFDD_XBox)|MFBIT(MFDD_OpenGL),		// TexFmt_DXT3 // 3 bit discreet alpha
	MFBIT(MFDD_D3D9)|MFBIT(MFDD_XBox),											// TexFmt_DXT4
	MFBIT(MFDD_D3D9)|MFBIT(MFDD_D3D11)|MFBIT(MFDD_XBox)|MFBIT(MFDD_OpenGL),		// TexFmt_DXT5 // 8 bit interpolated alpha

	MFBIT(MFDD_PSP),	// TexFmt_PSP_DXT1
	MFBIT(MFDD_PSP),	// TexFmt_PSP_DXT3
	MFBIT(MFDD_PSP),	// TexFmt_PSP_DXT5

	// platform specific swizzled formats
	MFBIT(MFDD_XBox),	// TexFmt_XB_A8R8G8B8
	MFBIT(MFDD_XBox),	// TexFmt_XB_A8B8G8R8
	MFBIT(MFDD_XBox),	// TexFmt_XB_B8G8R8A8
	MFBIT(MFDD_XBox),	// TexFmt_XB_R8G8B8A8

	MFBIT(MFDD_XBox),	// TexFmt_XB_R5G6B5
	MFBIT(MFDD_XBox),	// TexFmt_XB_R6G5B5

	MFBIT(MFDD_XBox),	// TexFmt_XB_A1R5G5B5
	MFBIT(MFDD_XBox),	// TexFmt_XB_R5G5B5A1

	MFBIT(MFDD_XBox),	// TexFmt_XB_A4R4G4B4
	MFBIT(MFDD_XBox),	// TexFmt_XB_R4G4B4A4

	MFBIT(MFDD_PSP),	// TexFmt_PSP_A8B8G8R8s
	MFBIT(MFDD_PSP),	// TexFmt_PSP_B5G6R5s
	MFBIT(MFDD_PSP),	// TexFmt_PSP_A1B5G5R5s
	MFBIT(MFDD_PSP),	// TexFmt_PSP_A4B4G4R4s

	MFBIT(MFDD_PSP),	// TexFmt_PSP_I8s
	MFBIT(MFDD_PSP),	// TexFmt_PSP_I4s

	MFBIT(MFDD_PSP),	// TexFmt_PSP_DXT1s
	MFBIT(MFDD_PSP),	// TexFmt_PSP_DXT3s
	MFBIT(MFDD_PSP),	// TexFmt_PSP_DXT5s
};
