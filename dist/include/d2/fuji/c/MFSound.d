...
{
	extern (C) void function(MFAudioStream*, const(char*)) nothrow pCreateStream;	/**< Create stream callback. */
	extern (C) size_t function(MFAudioStream*, void*, size_t) nothrow pGetSamples;	/**< Callback to get samples from the stream. */
	extern (C) void function(MFAudioStream*) nothrow pDestroyStream;				/**< Destroy stream callback. */
	extern (C) void function(MFAudioStream*, float) nothrow pSeekStream;			/**< Seek stream callbacks. */
	extern (C) float function(MFAudioStream*) nothrow pGetTime;						/**< Get the current stream time. */
}
