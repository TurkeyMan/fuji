...
{
	MFAuxType_Unknown = -1,	/**< Unknown auxillary display type. */

	MFAuxType_G15 = 0,		/**< Logitech G15 gaming keyboard. */
	MFAuxType_DreamcastVMU,	/**< Sega Dreamcast VMU. */

	MFAuxType_Max,			/**< Maximum device type. */
	MFAuxType_ForceInt = 0x7FFFFFFF	/**< Force MFAuxDisplayTypes to an integer type. */
};
...
enum MFAuxPriority
{
	MFAuxPriority_High = 2,		/**< Image is high priority and should be displayed immediately if possible. */
	MFAuxPriority_Normal = 5,	/**< Image is normal priority and should allow other applications with higher priority to take the display. */
	MFAuxPriority_Low = 8,		/**< Image is low priority and should always give priority to other applications. */

	MFAuxPriority_Max,			/**< Maximum priority. */
	MFAuxPriority_ForceInt = 0x7FFFFFFF	/**< Force MFAuxPriority to an int type. */
};
...
struct MFAuxDisplayProperties
{
	...
	uint32 numButtons;		/**< The number of soft buttons available on the device. */
	...
	MFInputDevice relatedInputDevice;	/**< The input device (if any) that is related to this screen. */
	int relatedInputDeviceID;			/**< The input deviceID of this screen. */
};
